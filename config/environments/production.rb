Epickone::Application.configure do
  ...
  config.action_mailer.default_url_options = {:host => "www.epickone.com.br"}
  config.action_mailer.raise_delivery_errors = true
  config.action_mailer.delivery_method = :smtp
  config.action_mailer.smtp_settings = {
    address: "email-smtp.us-east-1.amazonaws.com",
    port: 587,
    domain: "epickone.com.br",
    authentication: "plain",
    enable_starttls_auto: true,
    user_name: "AKIAIJMJEQAUZ4MEVDJQ",
    password: "ArwadaZPYeGzUSJO/iJMoQTqbkRkCwsx45ZyLCJIejcE"
  }
  ...
  config.middleware.use ExceptionNotifier,
    ...
    exception_recipients: 'marcellokazuo@gmail.com',
